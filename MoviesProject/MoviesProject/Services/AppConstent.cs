...
namespace MoviesProject.Services
{
    public class AppConstent
    {
        ...
        public static string GET_SignIn = "api/Profile/";
        //POST: api/Profile ==> Json param
        public static string POST_SignUp = "api/Profile";

        //GET: api/TopRatedMovies2Model
        public static string GET_TopRateMovies = "api/TopRatedMovies2Model";

        //GET: api/TopRatedMovies1Mode/1
